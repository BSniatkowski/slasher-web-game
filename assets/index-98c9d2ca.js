...
`].filter(Vo).join(`
`)),s=$d(s),s=f0(s,n),s=d0(s,n),a=$d(a),a=f0(a,n),a=d0(a,n),s=h0(s),a=h0(a),n.isWebGL2&&n.isRawShaderMaterial!==!0&&(g=`#version 300 es
